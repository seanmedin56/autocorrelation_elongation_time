% generates sample autocorrelation (and derivatives) figures for non
% constant elongation time. Elongation time is made non constant by drawing
% the distance a polymerase travels across a gene in a single time step
% from a Gaussian distribution

% makes folder for figures if it doesn't exist already
if ~exist('./../fig/gauss_plot_figs', 'dir')
    mkdir('./../fig/gauss_plot_figs');
end
